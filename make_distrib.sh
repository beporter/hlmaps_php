...
cp -rf styles CHANGELOG CONTRIBUTING CONTRIBUTORS hlmaps.conf.distrib hlmaps.cron hlmaps.inc hlmaps.php INSTALL INSTALL.MySQL LICENSE README STYLES101 TODO ../hlmaps_php-release/
